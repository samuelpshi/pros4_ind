"""
Round 1 Trader — v9-r1-jmerle
==============================

Identical trading logic to trader-v9-r1.py.
Adds the Logger class from trader-v8-173159-jmerle.py for jmerle visualizer
compatibility (--vis flag). Logger additions are minimally invasive; trading
logic is byte-identical to trader-v9-r1.py.

Differences from trader-v9-r1.py:
  1. Additional imports: Listing, Observation, ProsperityEncoder, Symbol, Trade, json, Any
  2. Logger class (verbatim from trader-v8-173159-jmerle.py)
  3. Module-level `logger = Logger()` instance
  4. `logger.flush(state, result, conversions, trader_data)` call before return
"""

from datamodel import Listing, Observation, Order, OrderDepth, ProsperityEncoder, Symbol, Trade, TradingState  # type: ignore
...
# ===========================================================================
# Logger — verbatim from trader-v8-173159-jmerle.py for jmerle visualizer
# ===========================================================================
...
# ---------------------------------------------------------------------------
ACTIVE_PRODUCTS = {"ASH_COATED_OSMIUM", "INTARIAN_PEPPER_ROOT"}
