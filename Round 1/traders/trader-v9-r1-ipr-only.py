"""
Round 1 Trader — v9-r1-ipr-only
=================================

IPR-only variant of trader-v9-r1.py.
ACTIVE_PRODUCTS = {"INTARIAN_PEPPER_ROOT"} — ACO is gated out.
All ACO constants and code remain in this file; only the set constant changes.
...
# ---------------------------------------------------------------------------
ACTIVE_PRODUCTS = {"INTARIAN_PEPPER_ROOT"}
