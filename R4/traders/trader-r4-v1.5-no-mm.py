...
CONFIG: Dict = {
    ...
    "VFX_LIMIT": 200,
    "VFX_TARGET_FRACTION": 0.15,    # cap follow at +/-50
    "VFX_BIG_TARGET_FRACTION": 0.30,# big M67 fill -> cap at +/-100
...
class Trader:
    ...
    def _vfx_orders(self, state: TradingState, persisted: Dict) -> List[Order]:
        ...
        # v1.5: persistent MM legs removed — only reactive lifts.
        # Hypothesis: passive quotes get adverse-selected (we get hit on the wrong
        # side when M67 is silent), eroding the M67-trade edge.
        return orders
