...
class Trader:
    def run(self, state: TradingState):
        ...
        # (joint cap ~109 for top 3 ATM legs vs VEV +/-200 cap; per-strike
        # tuned to keep aggregate delta hedgeable).
        ...
        for K in active_strikes:
            ...
            # Open: undervalued -> long; overvalued -> short.
            if z < -z_open:
                tgt = cap
            elif z > z_open:
                tgt = -cap
